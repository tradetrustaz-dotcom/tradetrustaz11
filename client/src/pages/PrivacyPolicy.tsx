        ...
        <div className="container max-w-4xl">
          ...
          >
            <LegalSection title="1. Overview">
              <p>
                TradeTrust AZ LLC ("Company," "we," "us," or "our") is committed to protecting your
                privacy. This Privacy Policy explains how we collect, use, store, and protect information
                when you use the TradeTrust AZ platform ("Platform"). By using the Platform, you agree
                to the data practices described in this policy.
              </p>
              <p>
                This policy is incorporated by reference into our{" "}
                <Link href="/legal/tos" className="underline" style={{ color: "#14B8A6" }}>Terms of Service</Link>.
            ...
            <LegalSection title="4. How We Use Your Information">
              ...
              <p>
                We do not use your data for behavioral advertising, third-party marketing, or any purpose
                not listed above without your explicit prior consent.
              </p>
            </LegalSection>

            <LegalSection title="5. No Sale of Personal Information">
              <p>
                TradeTrust AZ does not sell, rent, lease, or otherwise transfer your personally identifiable
                information (PII) to any third party for commercial purposes. This commitment applies
                regardless of any applicable "opt-out" rights under state law — we do not engage in
                the sale of personal data as a business practice.
              </p>
              <p>
                We do not share your PII with unverified third parties. The only third-party service
                providers who receive any user data are: (a) Stripe, Inc. for payment processing;
                (b) Amazon Web Services for encrypted document storage; and (c) our database hosting
                provider. All such providers are bound by data processing agreements that prohibit
            ...
            <LegalSection title="6. Data Security">
              <p>
                We implement industry-standard security measures including: TLS 1.3 encryption for all
                data in transit; AES-256 encryption for data at rest; role-based access controls limiting
                employee access to user data; regular security audits; and automated intrusion detection.
              </p>
              <p>
                No method of electronic transmission or storage is 100% secure. While we strive to
                protect your information, we cannot guarantee absolute security. In the event of a
                data breach affecting your PII, we will notify you within 72 hours as required by
                applicable law.
              </p>
            </LegalSection>
            ...
            <LegalSection title="7. Your Rights and Choices">
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2">
                ...
                <li><strong>Objection:</strong> Object to processing of your data for any purpose beyond service delivery.</li>
              </ul>
              <p>
                To exercise any of these rights, contact us at{" "}
                <a href="mailto:privacy@tradetrustaz.com" className="underline" style={{ color: "#14B8A6" }}>
            ...
            <LegalSection title="8. Cookies and Tracking">
              <p>
                ...
                analytics tools. Our analytics are powered by a self-hosted, privacy-preserving
                analytics platform that does not share data with third parties and does not track
                users across sites.
              </p>
            </LegalSection>
            ...
            <LegalSection title="9. Children's Privacy">
              <p>
                ...
                information to us, contact us immediately at{" "}
                <a href="mailto:privacy@tradetrustaz.com" className="underline" style={{ color: "#14B8A6" }}>
                  privacy@tradetrustaz.com
                </a>{" "}
            ...
            <LegalSection title="10. Changes to This Policy">
              <p>
                ...
                via email or prominent notice on the Platform at least fourteen (14) days before taking
            ...
            >
              <Link href="/legal/tos" className="underline" style={{ color: "#14B8A6" }}>
                Terms of Service →
              </Link>
