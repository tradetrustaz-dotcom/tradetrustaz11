...
const PLANS = [
  {
    ...
    tagline:
      "For homeowners who want an instant, independent pricing triage on a single estimate or invoice.",
    color: "#14B8A6",
  ...
  },
  {
    ...
    tagline:
      "For real estate investors and flippers auditing multiple residential bids across active projects.",
    color: "#F97316",
  ...
  },
  {
    ...
    tagline:
      "For property managers and commercial portfolios requiring continuous, high-volume maintenance auditing.",
    color: "#6366F1",
  ...
  },
  {
    ...
    tagline:
      "For licensed Arizona contractors who want to prove their pricing is fair and win more bids on transparency.",
    color: "#EAB308",
    ...
    <div className="min-h-screen" style={{ background: "#F8FAFC" }}>
      ...
      <section className="pt-28 pb-16" style={{ background: "#0F172A" }}>
        <div className="container text-center">
          ...
          >
            From a single homeowner checking one quote to enterprise property
            managers auditing hundreds of jobs — TradeTrust AZ scales with your
            needs.
          </p>
      ...
      <section className="py-16">
        <div className="container">
              ...
              >
                ...
                <div className="p-6 pt-5 flex-1 flex flex-col">
                  ...
                  {plan.note && (
                    ...
                    >
                      <span style={{ color: plan.note.color }}>
                        {plan.note.icon}
                      </span>
          ...
          >
            ...
            >
              Start with a Single Consumer Audit — no account required. Upgrade
