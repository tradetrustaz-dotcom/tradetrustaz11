...
export default function ContractorApply() {
  ...
  const validate = (): boolean => {
    ...
    if (!form.licenseNumber.trim())
      e.licenseNumber = "Arizona contractor license number is required";
    if (!form.tradeCategory) e.tradeCategory = "Trade category is required";
    if (!form.tosAccepted)
      e.tosAccepted = "You must accept the Terms of Service and Privacy Policy";
    if (!form.invoiceProtocolAccepted)
      e.invoiceProtocolAccepted =
        "You must accept the Invoice-Upload Verification Protocol";
    setErrors(e);
    ...
    return (
      <div className="min-h-screen" style={{ background: "#0F172A" }}>
        ...
        <div className="flex flex-col items-center justify-center min-h-screen px-4 text-center">
          ...
          >
            Thank you,{" "}
            <strong className="text-white">{form.businessName}</strong>. Your
            Contractor Membership application has been submitted for review.
          </p>
          <p
          ...
          >
            Our team will verify your Arizona contractor license and contact you
            at <strong className="text-white">{form.email}</strong> within 2–3
            business days with next steps, including your invoice upload portal
            access.
          </p>
    ...
    <div className="min-h-screen" style={{ background: "#F8FAFC" }}>
      ...
      <section className="pt-28 pb-10" style={{ background: "#0F172A" }}>
        <div className="container max-w-3xl">
          ...
          >
            The TradeTrust Verified badge is earned through data transparency —
            not purchased. Contractors who upload final, itemized invoices
            demonstrate honest pricing and earn consumer trust.
          </p>
        </div>
      </section>
        ...
        <div className="container max-w-3xl">
          ...
          >
            ...
            <div>
              ...
              >
                Contractors do not "buy" a ranking. To earn and maintain the
                TradeTrust Verified status, you must upload your final itemized
                invoices into the system to verify that your pricing matches
                market honesty. The badge proves data transparency, not a paid
                endorsement.
              </p>
            </div>
          </div>
            ...
            >
              ...
              <FormSection title="Invoice Verification Protocol">
                ...
                >
                  ...
                  >
                    <strong>Important:</strong> Submission of falsified or
                    altered invoices constitutes fraud and will result in
                    immediate membership termination and referral to the Arizona
                    Registrar of Contractors and appropriate law enforcement
                    authorities.
                  </p>
                </div>
                <div className="space-y-3">
                  ...
                  >
                    By applying, you agree to upload final, itemized invoices
                    for completed jobs on a regular basis. The TradeTrust
                    Verified badge will be awarded and maintained based on your
                    pricing consistency with market benchmarks — not as a paid
                    endorsement.
                  </p>
                  <div className="flex items-start gap-3">
                    ...
                    >
                      After approval, you will receive access to a secure
                      invoice upload portal. Invoices are processed through the
                      same automated analysis engine used for consumer audits to
                      ensure objective, unbiased scoring.
                    </p>
                  </div>
                </div>
              </FormSection>
              ...
              <FormSection title="Required Agreements">
                <div className="space-y-4">
                  ...
                  >
                    <label className="flex items-start gap-3 cursor-pointer">
                      ...
                      >
                        ...
                        , including all provisions related to Contractor
                        Membership and the merit-based verification
                        requirements.
                      </span>
                    </label>
                    {errors.tosAccepted && (
                  ...
                  <div
                    className="rounded-xl p-4"
                    style={{
                      background: form.invoiceProtocolAccepted
                        ? "rgba(20,184,166,0.05)"
                        : "rgba(15,23,42,0.02)",
                  ...
                  >
                    <label className="flex items-start gap-3 cursor-pointer">
                      <input
                        ...
                        onChange={e =>
                          set("invoiceProtocolAccepted", e.target.checked)
                        }
                        className="mt-0.5 w-4 h-4 rounded flex-shrink-0"
                        style={{ accentColor: "#14B8A6" }}
                      />
                      ...
                      >
                        ...
                        <strong>Invoice-Upload Verification Protocol</strong>,
                        including the requirement to upload final, itemized
                        invoices on a regular basis, and I understand that
                        submission of falsified or altered invoices will result
                        in immediate termination and referral to appropriate
                        authorities.
                      </span>
                    </label>
              ...
              <div className="pt-2">
                ...
                >
                  Applications are reviewed within 2–3 business days. Membership
                  is $149/month after approval — no charge until verified.{" "}
                  <Link
                    href="/pricing"
                    className="underline"
                    style={{ color: "#14B8A6" }}
