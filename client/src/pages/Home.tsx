...
const SCORE_FACTORS = [
  ...
  { label: "Review Language Patterns", weight: 20, desc: "Specific phrases customers use when they feel ripped off", color: "#14B8A6" },
...
const VIGNETTES = [
  ...
  },
  {
    ...
    city: "Tucson",
    job: "Water Heater",
    story: "Contractor said \"This water heater is dangerous, you need a new one today.\" Uploaded the quote. Saw average price was $1,800, not $4,200.",
  ...
  },
  {
    ...
    city: "Mesa",
    job: "Home Repair",
    story: "Pushy contractor at the door. Wife snapped a photo of the proposal, uploaded on her phone, showed her husband: \"This guy's trying to charge us double.\"",
        ...
        <div className="container relative z-10 pt-24 pb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                AI that actually reads the numbers on the page — not just reviews. See if you're being overcharged before you sign anything.
              </p>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-xs text-center" style={{ color: "rgba(255,255,255,0.3)", fontFamily: "'Inter', sans-serif", maxWidth: 480 }}>
              Data sourced from public records only and is for informational purposes only. TradeTrust AZ is not a licensed contractor referral service. For Arizona homeowners only (for now).
            </p>
